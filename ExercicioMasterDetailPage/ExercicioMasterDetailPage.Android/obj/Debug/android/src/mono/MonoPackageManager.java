...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "ExercicioMasterDetailPage.Android.dll" comes first in this list. */
		"ExercicioMasterDetailPage.Android.dll",
		"ExercicioMasterDetailPage.dll",
		"FormsViewGroup.dll",
